	...
	public Examen03() {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ResultSet busc = lib.buscar(textCodigo.getText());
				try {
					boolean records = busc.next();
					if(!records) {
						System.out.println("No se encontro el cliente");
					}
					tableReporte.setValueAt(busc.getInt("codigo"), 1, 0);
					tableReporte.setValueAt(busc.getString("apellidos"), 1, 1);
					tableReporte.setValueAt(busc.getString("nombres"), 1, 2);
					tableReporte.setValueAt(busc.getString("ruc"), 1, 3);
					tableReporte.setValueAt(busc.getDouble("lineaCredito"), 1, 4);	
